...
namespace PonyEngine::RenderDevice::Windows
{
	...
	void D3D12Device::CreateCBV(const D3D12_CONSTANT_BUFFER_VIEW_DESC* const cbvDesc, const D3D12_CPU_DESCRIPTOR_HANDLE handle) noexcept
	{
		device->CreateConstantBufferView(cbvDesc, handle);
	}

	void D3D12Device::CreateSRV(ID3D12Resource2* const resource, const D3D12_SHADER_RESOURCE_VIEW_DESC& srvDesc, const D3D12_CPU_DESCRIPTOR_HANDLE handle) noexcept
	{
		device->CreateShaderResourceView(resource, &srvDesc, handle);
	}

	void D3D12Device::CreateUAV(ID3D12Resource2* const resource, const D3D12_UNORDERED_ACCESS_VIEW_DESC& uavDesc, const D3D12_CPU_DESCRIPTOR_HANDLE handle) noexcept
	{
	...
	void D3D12Device::CreateSampler(const D3D12_SAMPLER_DESC2& samplerDesc, const D3D12_CPU_DESCRIPTOR_HANDLE handle) noexcept
	{
