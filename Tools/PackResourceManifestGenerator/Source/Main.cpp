...
void RemoveResources(const Command& command, toml::table& manifest)
{
	if (command.removeCommands.empty())
	{
		return;
	}
	...
	{
		std::println("Resource array not found.");
	}
}
