...
namespace Core
{
	TEST_CLASS(RGBTests)
	{
		...
		{
			Assert::IsTrue(std::is_same_v<float, PonyMath::Color::RGB<float>::ValueType>);
		}
		...
		{
			Assert::IsTrue(PonyMath::Color::RGB<float>::Predefined::Red == PonyMath::Color::RGB<float>(1.f, 0.f, 0.f));
			Assert::IsTrue(PonyMath::Color::RGB<float>::Predefined::Green == PonyMath::Color::RGB<float>(0.f, 1.f, 0.f));
			Assert::IsTrue(PonyMath::Color::RGB<float>::Predefined::Blue == PonyMath::Color::RGB<float>(0.f, 0.f, 1.f));
			Assert::IsTrue(PonyMath::Color::RGB<float>::Predefined::Black == PonyMath::Color::RGB<float>(0.f, 0.f, 0.f));
			Assert::IsTrue(PonyMath::Color::RGB<float>::Predefined::White == PonyMath::Color::RGB<float>(1.f, 1.f, 1.f));
			Assert::IsTrue(PonyMath::Color::RGB<float>::Predefined::Gray == PonyMath::Color::RGB<float>(0.5f, 0.5f, 0.5f));
			Assert::IsTrue(PonyMath::Color::RGB<float>::Predefined::Yellow == PonyMath::Color::RGB<float>(1.f, 1.f, 0.f));
			Assert::IsTrue(PonyMath::Color::RGB<float>::Predefined::Magenta == PonyMath::Color::RGB<float>(1.f, 0.f, 1.f));
			Assert::IsTrue(PonyMath::Color::RGB<float>::Predefined::Cyan == PonyMath::Color::RGB<float>(0.f, 1.f, 1.f));
		}

		TEST_METHOD(ConstructorTest)
		{
			auto defaultColor = PonyMath::Color::RGB<float>();
			...
			const auto arrayColor = PonyMath::Color::RGB<float>(array);
		...
		TEST_METHOD(IsBlackTest)
		{
			...
			Assert::IsTrue(PonyMath::Color::RGBInt<std::uint8_t>::Predefined::Black.IsBlack());
		}

		TEST_METHOD(IsAlmostBlackTest)
		{
			auto color = PonyMath::Color::RGB<float>::Predefined::Black;
			Assert::IsTrue(color.IsAlmostBlack());
			Assert::IsTrue(color.IsAlmostBlack(0.5f));

			for (std::size_t i = 0; i < PonyMath::Color::RGB<float>::ComponentCount; ++i)
			{
				...
				Assert::IsTrue(color.IsAlmostBlack(0.5f));
				color[i] = PonyMath::Color::RGB<float>::Predefined::Black[i];
			}
		}
		...
		{
			auto color = PonyMath::Color::RGB<float>::Predefined::White;
			...
			for (std::size_t i = 0; i < PonyMath::Color::RGB<float>::ComponentCount; ++i)
			{
				...
				Assert::IsTrue(color.IsAlmostWhite(0.5f));
				color[i] = PonyMath::Color::RGB<float>::Predefined::White[i];
			}
		}
		...
		TEST_METHOD(ToRGBTest)
		{
			...
			constexpr float b = 0.211f;
			constexpr auto color = PonyMath::Color::RGB<float>(r, g, b);
			auto doubleColor = static_cast<PonyMath::Color::RGB<double>>(color);
		...
		TEST_METHOD(ComponentAccessTest)
		{
			...
			constexpr auto colorC = PonyMath::Color::RGB<float>(r, g, b);
		...
		TEST_METHOD(CopyAssignmentTest)
		{
			...
			constexpr float b = 0.211f;
			constexpr auto color = PonyMath::Color::RGB<float>(r, g, b);
			auto copiedColor = PonyMath::Color::RGB<float>();
			PonyMath::Color::RGB<float>& colorRef = copiedColor = color;
			Assert::AreEqual(r, copiedColor.R());
			Assert::AreEqual(g, copiedColor.G());
			Assert::AreEqual(b, copiedColor.B());
		...
		TEST_METHOD(MoveAssignmentTest)
		{
			...
			constexpr float b = 0.211f;
			auto color = PonyMath::Color::RGB<float>(r, g, b);
			auto movedColor = PonyMath::Color::RGB<float>();
			PonyMath::Color::RGB<float>& colorRef = movedColor = std::move(color);
			Assert::AreEqual(r, movedColor.R());
			Assert::AreEqual(g, movedColor.G());
			Assert::AreEqual(b, movedColor.B());
		...
		TEST_METHOD(ProductAssignmentTest)
		{
			...
			PonyMath::Color::RGB<float>& colorRef = color *= multiplier;
		...
		TEST_METHOD(DivisionAssignmentTest)
		{
			...
			PonyMath::Color::RGB<float>& colorRef = color /= divisor;
		...
		TEST_METHOD(ClampTest)
		{
			...
			constexpr auto color2 = PonyMath::Color::RGB<float>(r2, g2, b2);
		...
		TEST_METHOD(LerpTest)
		{
			...
			PonyMath::Color::RGB<float> lerped = PonyMath::Color::Lerp(color, color1, 0.f);
		...
		TEST_METHOD(AreAlmostEqualTest)
		{
			...
			constexpr float b = 0.211f;
			constexpr auto color = PonyMath::Color::RGB<float>(r, g, b);
			PonyMath::Color::RGB<float> colorL = color;
		...
		TEST_METHOD(ProductTest)
		{
			...
			product = PonyMath::Color::RGB<float>();
		...
		static constexpr PonyMath::Color::RGB<float> RGBConstexpr()
		{
			auto color = PonyMath::Color::RGB<float>(0.3f, 0.4f, 0.6f);
