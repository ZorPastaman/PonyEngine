...
namespace Core
{
	TEST_CLASS(RGBATests)
	{
		...
		{
			Assert::IsTrue(std::is_same_v<float, PonyMath::Color::RGBA<float>::ValueType>);
		}

		TEST_METHOD(StaticDataTest)
		{
			Assert::AreEqual(std::size_t{4}, PonyMath::Color::RGBA<float>::ComponentCount);
		}

		TEST_METHOD(PredefinedTest)
		{
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::Red == PonyMath::Color::RGBA<float>(1.f, 0.f, 0.f, 1.f));
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::Green == PonyMath::Color::RGBA<float>(0.f, 1.f, 0.f, 1.f));
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::Blue == PonyMath::Color::RGBA<float>(0.f, 0.f, 1.f, 1.f));
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::Black == PonyMath::Color::RGBA<float>(0.f, 0.f, 0.f, 1.f));
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::White == PonyMath::Color::RGBA<float>(1.f, 1.f, 1.f, 1.f));
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::Clear == PonyMath::Color::RGBA<float>(0.f, 0.f, 0.f, 0.f));
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::Gray == PonyMath::Color::RGBA<float>(0.5f, 0.5f, 0.5f, 1.f));
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::Yellow == PonyMath::Color::RGBA<float>(1.f, 1.f, 0.f, 1.f));
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::Magenta == PonyMath::Color::RGBA<float>(1.f, 0.f, 1.f, 1.f));
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::Cyan == PonyMath::Color::RGBA<float>(0.f, 1.f, 1.f, 1.f));
		}

		TEST_METHOD(ConstructorTest)
		{
			auto defaultColor = PonyMath::Color::RGBA<float>();
			...
			const auto arrayColor = PonyMath::Color::RGBA<float>(array);
			Assert::AreEqual(r, arrayColor.R());
			Assert::AreEqual(g, arrayColor.G());
			Assert::AreEqual(b, arrayColor.B());
			Assert::AreEqual(a, arrayColor.A());

			constexpr auto rgb = PonyMath::Color::RGB<float>(r, g, b);
			auto rgba = PonyMath::Color::RGBA<float>(rgb, a);
			...
			auto vectorColor = PonyMath::Color::RGBA<float>(vector);
		...
		TEST_METHOD(IsBlackTest)
		{
			...
			Assert::IsTrue(PonyMath::Color::RGBAInt<std::uint8_t>::Predefined::Black.IsBlack());
		}
		...
		TEST_METHOD(IsAlmostBlackTest)
		{
			...
			for (std::size_t i = 0; i < PonyMath::Color::RGBA<float>::ComponentCount; ++i)
			{
				...
				Assert::IsTrue(color.IsAlmostBlack(0.5f));
				color[i] = PonyMath::Color::RGBA<float>::Predefined::Black[i];
			}
		}
		...
		TEST_METHOD(IsWhiteTest)
		{
			...
			Assert::IsTrue(PonyMath::Color::RGBAInt<std::uint8_t>::Predefined::White.IsWhite());
		}

		TEST_METHOD(IsAlmostWhiteTest)
		{
			auto color = PonyMath::Color::RGBA<float>::Predefined::White;
			...
			for (std::size_t i = 0; i < PonyMath::Color::RGBA<float>::ComponentCount; ++i)
			{
				...
				Assert::IsTrue(color.IsAlmostWhite(0.5f));
				color[i] = PonyMath::Color::RGBA<float>::Predefined::White[i];
			}
		}
		...
		TEST_METHOD(IsTransparent)
		{
			...
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::Clear.IsTransparent());
		}
		...
		TEST_METHOD(IsAlmostTransparent)
		{
			...
			Assert::IsTrue(color.IsAlmostTransparent(0.5f));
			Assert::IsTrue(PonyMath::Color::RGBA<float>::Predefined::Clear.IsAlmostTransparent());
		}
		...
		TEST_METHOD(ToRGBATest)
		{
			...
			constexpr float a = 0.166f;
			constexpr auto color = PonyMath::Color::RGBA<float>(r, g, b, a);
			auto doubleColor = static_cast<PonyMath::Color::RGBA<double>>(color);
		...
		TEST_METHOD(ToRGBTest)
		{
			...
			constexpr float a = 0.166f;
			constexpr auto color = PonyMath::Color::RGBA<float>(r, g, b, a);
			auto rgb = static_cast<PonyMath::Color::RGB<float>>(color);
		...
		TEST_METHOD(ToRGBIntTest)
		{
			...
			constexpr float a = 0.166f;
			constexpr auto color = PonyMath::Color::RGBA<float>(r, g, b, a);
			auto rgb = static_cast<PonyMath::Color::RGBInt<std::uint8_t>>(color);
		...
		TEST_METHOD(ToRGBAIntTest)
		{
			...
			constexpr float a = 0.166f;
			constexpr auto color = PonyMath::Color::RGBA<float>(r, g, b, a);
			auto rgba = static_cast<PonyMath::Color::RGBAInt<std::uint8_t>>(color);
		...
		TEST_METHOD(ComponentAccessTest)
		{
			...
			constexpr auto colorC = PonyMath::Color::RGBA<float>(r, g, b, a);
		...
		TEST_METHOD(CopyAssignmentTest)
		{
			...
			constexpr float a = 0.166f;
			constexpr auto color = PonyMath::Color::RGBA<float>(r, g, b, a);
			auto copiedColor = PonyMath::Color::RGBA<float>();
			PonyMath::Color::RGBA<float>& colorRef = copiedColor = color;
			Assert::AreEqual(r, copiedColor.R());
			Assert::AreEqual(g, copiedColor.G());
			Assert::AreEqual(b, copiedColor.B());
			Assert::AreEqual(a, copiedColor.A());
		...
		TEST_METHOD(MoveAssignmentTest)
		{
			...
			constexpr float a = 0.166f;
			auto color = PonyMath::Color::RGBA<float>(r, g, b, a);
			auto movedColor = PonyMath::Color::RGBA<float>();
			PonyMath::Color::RGBA<float>& colorRef = movedColor = std::move(color);
			Assert::AreEqual(r, movedColor.R());
			Assert::AreEqual(g, movedColor.G());
			Assert::AreEqual(b, movedColor.B());
			Assert::AreEqual(a, movedColor.A());
		...
		TEST_METHOD(ProductAssignmentTest)
		{
			...
			PonyMath::Color::RGBA<float>& colorRef = color *= multiplier;
		...
		TEST_METHOD(DivisionAssignmentTest)
		{
			...
			PonyMath::Color::RGBA<float>& colorRef = color /= divisor;
		...
		TEST_METHOD(MinCombinedTest)
		{
			...
			constexpr auto color1 = PonyMath::Color::RGBA<float>(r1, g1, b1, a1);
			auto min = PonyMath::Color::Min(color, color1);
		...
		TEST_METHOD(MaxCombinedTest)
		{
			...
			constexpr float a1 = 0.4;
			constexpr auto color1 = PonyMath::Color::RGBA<float>(r1, g1, b1, a1);
			auto max = PonyMath::Color::Max(color, color1);
		...
		TEST_METHOD(ClampTest)
		{
			...
			constexpr auto color2 = PonyMath::Color::RGBA<float>(r2, g2, b2, a2);

			auto clamped = PonyMath::Color::Clamp(color2, color, color1);
		...
		TEST_METHOD(LerpTest)
		{
			...
			PonyMath::Color::RGBA<float> lerped = PonyMath::Color::Lerp(color, color1, 0.f);
		...
		TEST_METHOD(AreAlmostEqualTest)
		{
			...
			constexpr float a = 0.166f;
			constexpr auto color = PonyMath::Color::RGBA<float>(r, g, b, a);
			PonyMath::Color::RGBA<float> colorL = color;

			for (std::size_t i = 0; i < PonyMath::Color::RGBA<float>::ComponentCount; ++i)
			{
				Assert::IsTrue(PonyMath::Color::AreAlmostEqual(colorL, color));
				colorL[i] = std::nextafter(colorL[i], 0.f);
				Assert::IsTrue(PonyMath::Color::AreAlmostEqual(colorL, color));
				colorL[i] += 1;
				Assert::IsFalse(PonyMath::Color::AreAlmostEqual(colorL, color));
				Assert::IsTrue(PonyMath::Color::AreAlmostEqual(colorL, color, 5.f));
				colorL[i] = color[i];
			}
		}
		...
		TEST_METHOD(ProductTest)
		{
			...
			product = PonyMath::Color::RGBA<float>();
		...
		static constexpr PonyMath::Color::RGBA<float> RGBAConstexpr()
		{
			auto color = PonyMath::Color::RGBA<float>(0.3f, 0.4f, 0.6f, 0.69f);
		...
		{
			[[maybe_unused]] constexpr auto defaultColor = PonyMath::Color::RGBA<float>();
			...
			[[maybe_unused]] constexpr float distanceSquared = PonyMath::Color::DistanceSquared(color, defaultColor);

			[[maybe_unused]] constexpr auto minCombined = PonyMath::Color::Min(defaultColor, spanColor);
			[[maybe_unused]] constexpr auto maxCombined = PonyMath::Color::Max(defaultColor, spanColor);
			[[maybe_unused]] constexpr auto clamped = PonyMath::Color::Clamp(color, defaultColor, spanColor);
			[[maybe_unused]] constexpr auto lerp = PonyMath::Color::Lerp(color, defaultColor, 0.5f);

			[[maybe_unused]] constexpr bool areAlmostEqual = PonyMath::Color::AreAlmostEqual(color, defaultColor);
