...
namespace Core
{
	TEST_CLASS(RGBIntTests)
	{
		...
		{
			Assert::IsTrue(std::is_same_v<std::uint8_t, PonyMath::Color::RGBInt<std::uint8_t>::ValueType>);
		}

		TEST_METHOD(StaticDataTest)
		{
			Assert::AreEqual(std::numeric_limits<std::uint8_t>::max(), PonyMath::Color::RGBInt<std::uint8_t>::MaxValue);
			Assert::AreEqual(std::size_t{3}, PonyMath::Color::RGBInt<std::uint8_t>::ComponentCount);
		}

		TEST_METHOD(PredefinedTest)
		{
			Assert::IsTrue(PonyMath::Color::RGBInt<std::uint8_t>::Predefined::Red == PonyMath::Color::RGBInt<std::uint8_t>(255, 0, 0));
			Assert::IsTrue(PonyMath::Color::RGBInt<std::uint8_t>::Predefined::Green == PonyMath::Color::RGBInt<std::uint8_t>(0, 255, 0));
			Assert::IsTrue(PonyMath::Color::RGBInt<std::uint8_t>::Predefined::Blue == PonyMath::Color::RGBInt<std::uint8_t>(0, 0, 255));
			Assert::IsTrue(PonyMath::Color::RGBInt<std::uint8_t>::Predefined::Black == PonyMath::Color::RGBInt<std::uint8_t>(0, 0, 0));
			Assert::IsTrue(PonyMath::Color::RGBInt<std::uint8_t>::Predefined::White == PonyMath::Color::RGBInt<std::uint8_t>(255, 255, 255));
			Assert::IsTrue(PonyMath::Color::RGBInt<std::uint8_t>::Predefined::Yellow == PonyMath::Color::RGBInt<std::uint8_t>(255, 255, 0));
			Assert::IsTrue(PonyMath::Color::RGBInt<std::uint8_t>::Predefined::Magenta == PonyMath::Color::RGBInt<std::uint8_t>(255, 0, 255));
			Assert::IsTrue(PonyMath::Color::RGBInt<std::uint8_t>::Predefined::Cyan == PonyMath::Color::RGBInt<std::uint8_t>(0, 255, 255));
		}

		TEST_METHOD(ConstructorTest)
		{
			auto defaultColor = PonyMath::Color::RGBInt<std::uint8_t>();
			...
			const auto arrayColor = PonyMath::Color::RGBInt<std::uint8_t>(array);
			...
			auto vectorColor = PonyMath::Color::RGBInt<std::uint8_t>(vector);
		...
		TEST_METHOD(IsBlackTest)
		{
			...
			constexpr std::uint8_t g = 200;
			constexpr std::uint8_t b = 1;
			constexpr auto color = PonyMath::Color::RGBInt<std::uint8_t>(r, g, b);
		...
		TEST_METHOD(MinCombinedTest)
		{
			...
			constexpr auto color1 = PonyMath::Color::RGBInt<std::uint8_t>(r1, g1, b1);
		...
		TEST_METHOD(ClampTest)
		{
			...
			constexpr auto color2 = PonyMath::Color::RGBInt<std::uint8_t>(r2, g2, b2);
		...
		TEST_METHOD(AssignmentOperatorsTest)
		{
			...
			auto otherColor = PonyMath::Color::RGBInt<std::uint8_t>(otherR, otherG, otherB);
			PonyMath::Color::RGBInt<std::uint8_t>& result = color = otherColor;
			...
			color = PonyMath::Color::RGBInt<std::uint8_t>(r, g, b);
			PonyMath::Color::RGBInt<std::uint8_t>& otherResult = otherColor = std::move(color);
		...
		TEST_METHOD(EqualTest)
		{
			...
			for (std::size_t i = 0; i < PonyMath::Color::RGBInt<std::uint8_t>::ComponentCount; ++i)
			{
		...
		static constexpr PonyMath::Color::RGBInt<std::uint8_t> ColorConstexpr()
		{
			auto color = PonyMath::Color::RGBInt<std::uint8_t>(3, 250, 128);
			auto copiedColor = color;
			auto movedColor = std::move(color);
		...
		{
			[[maybe_unused]] constexpr auto defaultColor = PonyMath::Color::RGBInt<std::uint8_t>();
			[[maybe_unused]] constexpr auto color = PonyMath::Color::RGBInt<std::uint8_t>(3, 250, 128);
			[[maybe_unused]] constexpr auto arrayColor = PonyMath::Color::RGBInt<std::uint8_t>(std::array{color.R(), color.G(), color.B()});
