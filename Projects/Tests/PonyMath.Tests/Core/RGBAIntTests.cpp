...
namespace Math
{
	TEST_CLASS(RGBAIntTests)
	{
		...
		{
			Assert::IsTrue(std::is_same_v<std::uint8_t, PonyMath::Core::RGBAInt<std::uint8_t>::ValueType>);
		}

		TEST_METHOD(StaticDataTest)
		{
			Assert::AreEqual(std::numeric_limits<std::uint8_t>::max(), PonyMath::Core::RGBAInt<std::uint8_t>::MaxValue);
			Assert::AreEqual(std::size_t{4}, PonyMath::Core::RGBAInt<std::uint8_t>::ComponentCount);
		}

		TEST_METHOD(PredefinedTest)
		{
			Assert::IsTrue(PonyMath::Core::RGBAInt<std::uint8_t>::Predefined::Red == PonyMath::Core::RGBAInt<std::uint8_t>(255, 0, 0, 255));
			Assert::IsTrue(PonyMath::Core::RGBAInt<std::uint8_t>::Predefined::Green == PonyMath::Core::RGBAInt<std::uint8_t>(0, 255, 0, 255));
			Assert::IsTrue(PonyMath::Core::RGBAInt<std::uint8_t>::Predefined::Blue == PonyMath::Core::RGBAInt<std::uint8_t>(0, 0, 255, 255));
			Assert::IsTrue(PonyMath::Core::RGBAInt<std::uint8_t>::Predefined::Black == PonyMath::Core::RGBAInt<std::uint8_t>(0, 0, 0, 255));
			Assert::IsTrue(PonyMath::Core::RGBAInt<std::uint8_t>::Predefined::White == PonyMath::Core::RGBAInt<std::uint8_t>(255, 255, 255, 255));
			Assert::IsTrue(PonyMath::Core::RGBAInt<std::uint8_t>::Predefined::Clear == PonyMath::Core::RGBAInt<std::uint8_t>(0, 0, 0, 0));
			Assert::IsTrue(PonyMath::Core::RGBAInt<std::uint8_t>::Predefined::Yellow == PonyMath::Core::RGBAInt<std::uint8_t>(255, 255, 0, 255));
			Assert::IsTrue(PonyMath::Core::RGBAInt<std::uint8_t>::Predefined::Magenta == PonyMath::Core::RGBAInt<std::uint8_t>(255, 0, 255, 255));
			Assert::IsTrue(PonyMath::Core::RGBAInt<std::uint8_t>::Predefined::Cyan == PonyMath::Core::RGBAInt<std::uint8_t>(0, 255, 255, 255));
		}

		TEST_METHOD(ConstructorTest)
		{
			auto defaultColor = PonyMath::Core::RGBAInt<std::uint8_t>();
			...
			auto color = PonyMath::Core::RGBAInt<std::uint8_t>(r, g, b, a);
			...
			const auto arrayColor = PonyMath::Core::RGBAInt<std::uint8_t>(array);
			Assert::AreEqual(r, arrayColor.R());
			Assert::AreEqual(g, arrayColor.G());
			Assert::AreEqual(b, arrayColor.B());
			Assert::AreEqual(a, arrayColor.A());

			constexpr auto rgb = PonyMath::Core::RGBInt(r, g, b);
			const auto rgba = PonyMath::Core::RGBAInt<std::uint8_t>(rgb, a);
			...
			auto vectorColor = PonyMath::Core::RGBAInt<std::uint8_t>(vector);
		...
		TEST_METHOD(AccessTest)
		{
			...
			Assert::AreEqual(b, color.B());
			Assert::AreEqual(a, color.A());
			constexpr auto cColor = PonyMath::Core::RGBAInt<std::uint8_t>(r, g, b, a);
		...
		TEST_METHOD(IsBlackTest)
		{
			...
			constexpr std::uint8_t b = 1;
			constexpr std::uint8_t a = 201;
			constexpr auto color = PonyMath::Core::RGBAInt<std::uint8_t>(r, g, b, a);
		...
		TEST_METHOD(IsTransparent)
		{
			...
			Assert::IsTrue(PonyMath::Core::RGBAInt<std::uint8_t>::Predefined::Clear.IsTransparent());
		}
		...
		TEST_METHOD(SetTest)
		{
			...
			constexpr std::uint8_t b = 1;
			constexpr std::uint8_t a = 201;
			auto color = PonyMath::Core::RGBAInt<std::uint8_t>();
			color.Set(r, g, b, a);
			Assert::AreEqual(r, color.R());
			Assert::AreEqual(g, color.G());
			Assert::AreEqual(b, color.B());
			Assert::AreEqual(a, color.A());
			color = PonyMath::Core::RGBAInt<std::uint8_t>();
		...
		TEST_METHOD(MinCombinedTest)
		{
			...
			constexpr auto color1 = PonyMath::Core::RGBAInt<std::uint8_t>(r1, g1, b1, a1);
		...
		TEST_METHOD(ClampTest)
		{
			...
			constexpr auto color2 = PonyMath::Core::RGBAInt<std::uint8_t>(r2, g2, b2, a2);
		...
		TEST_METHOD(ToRGBIntTest)
		{
			...
			constexpr std::uint8_t a = 201;
			constexpr auto color = PonyMath::Core::RGBAInt<std::uint8_t>(r, g, b, a);
			const auto rgb = static_cast<PonyMath::Core::RGBInt<std::uint8_t>>(color);
		...
		TEST_METHOD(AssignmentOperatorsTest)
		{
			...
			auto otherColor = PonyMath::Core::RGBAInt<std::uint8_t>(otherR, otherG, otherB, otherA);
			PonyMath::Core::RGBAInt<std::uint8_t>& result = color = otherColor;
			...
			color = PonyMath::Core::RGBAInt<std::uint8_t>(r, g, b, a);
			PonyMath::Core::RGBAInt<std::uint8_t>& otherResult = otherColor = std::move(color);
		...
		TEST_METHOD(EqualTest)
		{
			...
			for (std::size_t i = 0; i < PonyMath::Core::RGBAInt<std::uint8_t>::ComponentCount; ++i)
			{
		...
		static constexpr PonyMath::Core::RGBAInt<std::uint8_t> ColorConstexpr()
		{
			auto color = PonyMath::Core::RGBAInt<std::uint8_t>(3, 250, 128, 111);
			auto copiedColor = color;
			auto movedColor = std::move(color);
		...
		{
			[[maybe_unused]] constexpr auto defaultColor = PonyMath::Core::RGBAInt<std::uint8_t>();
			[[maybe_unused]] constexpr auto color = PonyMath::Core::RGBAInt<std::uint8_t>(3, 250, 128, 100);
			[[maybe_unused]] constexpr auto rgb = PonyMath::Core::RGBAInt<std::uint8_t>(PonyMath::Core::RGBInt<std::uint8_t>(3, 156, 69), 100);
			[[maybe_unused]] constexpr auto arrayColor = PonyMath::Core::RGBAInt<std::uint8_t>(std::array{color.R(), color.G(), color.B(), color.A()});
			...
			[[maybe_unused]] constexpr auto gotRgb = static_cast<PonyMath::Core::RGBInt<std::uint8_t>>(color);
