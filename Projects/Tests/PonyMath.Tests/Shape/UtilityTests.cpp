...
namespace Shape
{
	TEST_CLASS(UtilityTests)
	{
		TEST_METHOD(CreateBoundingRectTest)
		{
			...
			Assert::IsTrue(PonyMath::Shape::AABR<float>::Predefined::Zero == aabr);
			...
			Assert::IsTrue(PonyMath::Shape::AreAlmostEqual(PonyMath::Shape::AABR<float>(points[0], PonyMath::Core::Vector2<float>::Predefined::Zero), aabr));
			...
			aabr = PonyMath::Shape::CreateBoundingRect(std::span<const PonyMath::Core::Vector2<float>>(points.data(), points.size()));
			Assert::IsTrue(PonyMath::Shape::AreAlmostEqual(PonyMath::Shape::AABR<float>(PonyMath::Core::Vector2<float>(0.f, 5.f), PonyMath::Core::Vector2<float>(4.f, 15.f)), aabr));
		}
		...
		TEST_METHOD(CreateBoundingBoxTest)
		{
			...
			Assert::IsTrue(PonyMath::Shape::AABB<float>::Predefined::Zero == aabb);
			...
			Assert::IsTrue(PonyMath::Shape::AreAlmostEqual(PonyMath::Shape::AABB<float>(points[0], PonyMath::Core::Vector3<float>::Predefined::Zero), aabb));
			...
			aabb = PonyMath::Shape::CreateBoundingBox(std::span<const PonyMath::Core::Vector3<float>>(points.data(), points.size()));
			Assert::IsTrue(PonyMath::Shape::AreAlmostEqual(PonyMath::Shape::AABB<float>(PonyMath::Core::Vector3<float>(0.f, 5.f, -1.5f), PonyMath::Core::Vector3<float>(4.f, 15.f, 3.5f)), aabb));
		}
	};
}
