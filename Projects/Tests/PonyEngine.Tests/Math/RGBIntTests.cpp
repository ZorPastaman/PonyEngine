...
namespace Math
{
	TEST_CLASS(RGBIntTests)
	{
		...
		TEST_METHOD(ConstructorTest)
		{
			...
			const auto arrayColor = PonyEngine::Math::RGBInt<std::uint8_t>(array);
		...
		TEST_METHOD(MinCombinedTest)
		{
			...
			constexpr auto color1 = PonyEngine::Math::RGBInt<std::uint8_t>(r1, g1, b1);
		...
		TEST_METHOD(ClampTest)
		{
			...
			constexpr auto color2 = PonyEngine::Math::RGBInt<std::uint8_t>(r2, g2, b2);
		...
		TEST_METHOD(ConstexprTest)
		{
			...
			[[maybe_unused]] constexpr auto arrayColor = PonyEngine::Math::RGBInt<std::uint8_t>(std::array{color.R(), color.G(), color.B()});
