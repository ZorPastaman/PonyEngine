...
namespace Math
{
	TEST_CLASS(Vector3Tests)
	{
		...
		TEST_METHOD(MinCombinedShortTest)
		{
			...
			constexpr auto vector1 = PonyEngine::Math::Vector3<short>(x1, y1, z1);
		...
		TEST_METHOD(ClampShortTest)
		{
			...
			constexpr auto vector2 = PonyEngine::Math::Vector3<short>(x2, y2, z2);
		...
		TEST_METHOD(ConstexprCompilationTest)
		{
			...
			[[maybe_unused]] constexpr PonyEngine::Math::Vector3<float> minCombined = PonyEngine::Math::Min(defaultVector, arrayVector);
			[[maybe_unused]] constexpr PonyEngine::Math::Vector3<float> maxCombined = PonyEngine::Math::Max(defaultVector, arrayVector);
			[[maybe_unused]] constexpr PonyEngine::Math::Vector3<float> clamped = PonyEngine::Math::Clamp(vector, defaultVector, arrayVector);
