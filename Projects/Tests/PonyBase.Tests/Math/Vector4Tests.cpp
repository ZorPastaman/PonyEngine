...
namespace Math
{
	TEST_CLASS(Vector4Tests)
	{
		...
		{
			Assert::IsTrue(std::is_same_v<char, PonyBase::Math::Vector4<char>::ValueType>);
			Assert::IsTrue(std::is_same_v<float, PonyBase::Math::Vector4<char>::ComputationalType>);

			Assert::IsTrue(std::is_same_v<short, PonyBase::Math::Vector4<short>::ValueType>);
			Assert::IsTrue(std::is_same_v<float, PonyBase::Math::Vector4<short>::ComputationalType>);

			Assert::IsTrue(std::is_same_v<int, PonyBase::Math::Vector4<int>::ValueType>);
			Assert::IsTrue(std::is_same_v<float, PonyBase::Math::Vector4<int>::ComputationalType>);

			Assert::IsTrue(std::is_same_v<float, PonyBase::Math::Vector4<float>::ValueType>);
			Assert::IsTrue(std::is_same_v<float, PonyBase::Math::Vector4<float>::ComputationalType>);

			Assert::IsTrue(std::is_same_v<long long, PonyBase::Math::Vector4<long long>::ValueType>);
			Assert::IsTrue(std::is_same_v<double, PonyBase::Math::Vector4<long long>::ComputationalType>);

			Assert::IsTrue(std::is_same_v<double, PonyBase::Math::Vector4<double>::ValueType>);
			Assert::IsTrue(std::is_same_v<double, PonyBase::Math::Vector4<double>::ComputationalType>);
		}

		TEST_METHOD(StaticDataTest)
		{
			Assert::AreEqual(std::size_t{4}, PonyBase::Math::Vector4<float>::ComponentCount);
			Assert::AreEqual(std::size_t{4}, PonyBase::Math::Vector4<short>::ComponentCount);
		}

		TEST_METHOD(DefaultConstructorShortTest)
		{
			const auto vector = PonyBase::Math::Vector4<short>();
		...
		{
			const auto vector = PonyBase::Math::Vector4<float>();
		...
		TEST_METHOD(ConstructorShortTest)
		{
			...
			constexpr short z = 5;
			constexpr short w = -2;
			const auto vector = PonyBase::Math::Vector4<short>(x, y, z, w);
		...
		TEST_METHOD(ConstructorFloatTest)
		{
			...
			constexpr float z = 5;
			constexpr float w = -2;
			const auto vector = PonyBase::Math::Vector4<float>(x, y, z, w);
			Assert::AreEqual(x, vector.X());
			Assert::AreEqual(y, vector.Y());
			Assert::AreEqual(z, vector.Z());
			Assert::AreEqual(w, vector.W());
		...
		TEST_METHOD(ConstructorSpanShortTest)
		{
			...
			constexpr short z = 5;
			constexpr short w = -2;
			const auto vector = PonyBase::Math::Vector4<short>(std::array<short, 4>{x, y, z, w});
			Assert::AreEqual(x, vector.X());
			Assert::AreEqual(y, vector.Y());
			Assert::AreEqual(z, vector.Z());
			Assert::AreEqual(w, vector.W());
		...
		TEST_METHOD(ConstructorSpanFloatTest)
		{
			...
			constexpr float z = 5;
			constexpr float w = -2;
			const auto vector = PonyBase::Math::Vector4<float>(std::array<float, 4>{x, y, z, w});
			Assert::AreEqual(x, vector.X());
			Assert::AreEqual(y, vector.Y());
			Assert::AreEqual(z, vector.Z());
			Assert::AreEqual(w, vector.W());
		...
		TEST_METHOD(ConstructorCopyShortTest)
		{
			...
			constexpr short z = 5;
			constexpr short w = -2;
			constexpr auto vector = PonyBase::Math::Vector4<short>(x, y, z, w);
			const PonyBase::Math::Vector4<short> copiedVector = vector;
		...
		TEST_METHOD(ConstructorCopyFloatTest)
		{
			...
			const PonyBase::Math::Vector4<float> copiedVector = vector;
			Assert::AreEqual(x, copiedVector.X());
			Assert::AreEqual(y, copiedVector.Y());
			Assert::AreEqual(z, copiedVector.Z());
			Assert::AreEqual(w, copiedVector.W());
		...
		TEST_METHOD(ConstructorMoveShortTest)
		{
			...
			constexpr short z = 5;
			constexpr short w = -2;
			auto vector = PonyBase::Math::Vector4<short>(x, y, z, w);
			const PonyBase::Math::Vector4<short> copiedVector = std::move(vector);
			Assert::AreEqual(x, copiedVector.X());
			Assert::AreEqual(y, copiedVector.Y());
			Assert::AreEqual(z, copiedVector.Z());
			Assert::AreEqual(w, copiedVector.W());
		...
		TEST_METHOD(ConstructorMoveFloatTest)
		{
			...
			constexpr float z = 5;
			constexpr float w = -2;
			auto vector = PonyBase::Math::Vector4<float>(x, y, z, w);
			const PonyBase::Math::Vector4<float> copiedVector = std::move(vector);
			Assert::AreEqual(x, copiedVector.X());
			Assert::AreEqual(y, copiedVector.Y());
			Assert::AreEqual(z, copiedVector.Z());
			Assert::AreEqual(w, copiedVector.W());
		...
		TEST_METHOD(ComponentAccessShortTest)
		{
			...
			constexpr auto vectorC = PonyBase::Math::Vector4<short>(x, y, z, w);
		...
		TEST_METHOD(ComponentAccessFloatTest)
		{
			...
			constexpr auto vectorC = PonyBase::Math::Vector4<float>(x, y, z, w);
			Assert::AreEqual(x, vectorC.X());
			Assert::AreEqual(y, vectorC.Y());
			Assert::AreEqual(z, vectorC.Z());
			Assert::AreEqual(w, vectorC.W());
		...
		TEST_METHOD(MagnitudeShortTest)
		{
			...
			Assert::AreEqual(0.f, PonyBase::Math::Vector4<short>::Predefined::Zero.Magnitude());
		}
		...
		TEST_METHOD(MagnitudeFloatTest)
		{
			...
			Assert::AreEqual(0.f, PonyBase::Math::Vector4<float>::Predefined::Zero.Magnitude());
		}
		...
		TEST_METHOD(MagnitudeSquaredShortTest)
		{
			...
			Assert::AreEqual(short{0}, PonyBase::Math::Vector4<short>::Predefined::Zero.MagnitudeSquared());
		}
		...
		TEST_METHOD(MagnitudeSquaredFloatTest)
		{
			...
			Assert::AreEqual(0.f, PonyBase::Math::Vector4<float>::Predefined::Zero.MagnitudeSquared());
		}
		...
		TEST_METHOD(NormalizeFloatTest)
		{
			...
			constexpr float w = -2;
			auto vector = PonyBase::Math::Vector4<float>(x, y, z, w);
			const PonyBase::Math::Vector4<float> normalized = vector.Normalized();
		...
		TEST_METHOD(MinShortTest)
		{
			...
			constexpr auto cVector = PonyBase::Math::Vector4<short>(x, y, z, w);
		...
		TEST_METHOD(MinFloatTest)
		{
			...
			constexpr auto cVector = PonyBase::Math::Vector4<float>(x, y, z, w);
		...
		TEST_METHOD(SwapShortTest)
		{
			...
			constexpr short w = -2;
			auto vector = PonyBase::Math::Vector4<short>(x, y, z, w);
			const PonyBase::Math::Vector4<short> swapped = vector.Swapped();
		...
		TEST_METHOD(SwapFloatTest)
		{
			...
			constexpr float w = -2;
			auto vector = PonyBase::Math::Vector4<float>(x, y, z, w);
			const PonyBase::Math::Vector4<float> swapped = vector.Swapped();
			Assert::AreEqual(w, swapped.X());
			Assert::AreEqual(z, swapped.Y());
			Assert::AreEqual(y, swapped.Z());
			Assert::AreEqual(x, swapped.W());
		...
		{
			Assert::IsTrue(PonyBase::Math::Vector4<short>::Predefined::Zero.IsZero());

			auto matrix = PonyBase::Math::Vector4<short>::Predefined::Zero;
			Assert::IsTrue(matrix.IsZero());

			for (std::size_t i = 0; i < PonyBase::Math::Vector4<float>::ComponentCount; ++i)
			{
				matrix.Span()[i] += 1;
				Assert::IsFalse(matrix.IsZero());
				matrix.Span()[i] = PonyBase::Math::Vector4<short>::Predefined::Zero.Span()[i];
			}
		}

		TEST_METHOD(IsZeroFloatTest)
		{
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::Zero.IsZero());

			auto matrix = PonyBase::Math::Vector4<float>::Predefined::Zero;
			Assert::IsTrue(matrix.IsZero());
			...
			for (std::size_t i = 0; i < PonyBase::Math::Vector4<float>::ComponentCount; ++i)
			{
				...
				matrix.Span()[i] += 1;
				Assert::IsFalse(matrix.IsZero());
				matrix.Span()[i] = PonyBase::Math::Vector4<float>::Predefined::Zero.Span()[i];
			}
		}

		TEST_METHOD(IsAlmostZeroTest)
		{
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::Zero.IsAlmostZero());
		...
		{
			Assert::IsFalse(PonyBase::Math::Vector4<short>::Predefined::Zero.IsUnit());
			Assert::IsFalse(PonyBase::Math::Vector4<short>::Predefined::One.IsUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<short>(1, 0, 0, 0).IsUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<short>(0, 1, 0, 0).IsUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<short>(0, 0, 1, 0).IsUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<short>(0, 0, 0, 1).IsUnit());
		}

		TEST_METHOD(IsUnitFloatTest)
		{
			Assert::IsFalse(PonyBase::Math::Vector4<float>::Predefined::Zero.IsUnit());
			Assert::IsFalse(PonyBase::Math::Vector4<float>::Predefined::One.IsUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<float>(1, 0, 0, 0).IsUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<float>(0, 1, 0, 0).IsUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<float>(0, 0, 1, 0).IsUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<float>(0, 0, 0, 1).IsUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::One.Normalized().IsUnit());
		}

		TEST_METHOD(IsAlmostUnitTest)
		{
			Assert::IsFalse(PonyBase::Math::Vector4<float>::Predefined::Zero.IsAlmostUnit());
			Assert::IsFalse(PonyBase::Math::Vector4<float>::Predefined::One.IsAlmostUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<float>(1, 0, 0, 0).IsAlmostUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<float>(0, 1, 0, 0).IsAlmostUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<float>(0, 0, 1, 0).IsAlmostUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<float>(0, 0, 0, 1).IsAlmostUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::One.Normalized().IsAlmostUnit());
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::One.IsAlmostUnit(5.f));
		}

		TEST_METHOD(IsUniformShortTest)
		{
			Assert::IsTrue(PonyBase::Math::Vector4<short>::Predefined::Zero.IsUniform());
			Assert::IsTrue(PonyBase::Math::Vector4<short>::Predefined::One.IsUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<short>(1, 0, 0, 0).IsUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<short>(0, 1, 0, 0).IsUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<short>(0, 0, 1, 0).IsUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<short>(0, 0, 0, 1).IsUniform());
		}

		TEST_METHOD(IsUniformFloatTest)
		{
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::Zero.IsUniform());
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::One.IsUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<float>(1, 0, 0, 0).IsUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<float>(0, 1, 0, 0).IsUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<float>(0, 0, 1, 0).IsUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<float>(0, 0, 0, 1).IsUniform());
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::One.Normalized().IsUniform());
		}

		TEST_METHOD(IsAlmostUniformyTest)
		{
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::Zero.IsAlmostUniform());
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::One.IsAlmostUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<float>(1, 0, 0, 0).IsAlmostUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<float>(0, 1, 0, 0).IsAlmostUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<float>(0, 0, 1, 0).IsAlmostUniform());
			Assert::IsFalse(PonyBase::Math::Vector4<float>(0, 0, 0, 1).IsAlmostUniform());
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::One.Normalized().IsAlmostUniform());
			Assert::IsTrue(PonyBase::Math::Vector4<float>(1, 0, 0, 0).IsAlmostUniform(5.f));
		}
		...
		TEST_METHOD(ScaleThisShortTest)
		{
			...
			constexpr auto scale = PonyBase::Math::Vector4<short>(xS, yS, zS, wS);
			vector.Scale(scale);
		...
		TEST_METHOD(ScaleThisFloatTest)
		{
			...
			constexpr auto scale = PonyBase::Math::Vector4<float>(xS, yS, zS, wS);
			vector.Scale(scale);
		...
		{
			constexpr auto floatVector = PonyBase::Math::Vector4<float>(3.1f, -2.2f, 4.4f, -2.1f);
			const auto intVector = static_cast<PonyBase::Math::Vector4<int>>(floatVector);
		...
		TEST_METHOD(CopyAssignmentShortTest)
		{
			...
			constexpr short w = -2;
			constexpr auto vector = PonyBase::Math::Vector4<short>(x, y, z, w);
			auto copiedVector = PonyBase::Math::Vector4<short>();
			copiedVector = vector;
			Assert::AreEqual(x, copiedVector.X());
			Assert::AreEqual(y, copiedVector.Y());
			Assert::AreEqual(z, copiedVector.Z());
		...
		TEST_METHOD(CopyAssignmentFloatTest)
		{
			...
			constexpr float w = -2;
			constexpr auto vector = PonyBase::Math::Vector4<float>(x, y, z, w);
			auto copiedVector = PonyBase::Math::Vector4<float>();
			copiedVector = vector;
			Assert::AreEqual(x, copiedVector.X());
			Assert::AreEqual(y, copiedVector.Y());
			Assert::AreEqual(z, copiedVector.Z());
		...
		TEST_METHOD(SumAssignmentShortTest)
		{
			...
			constexpr auto vectorR = PonyBase::Math::Vector4<short>(xR, yR, zR, wR);
			constexpr short xC = 6;
			constexpr short yC = 4;
			constexpr short zC = -2;
			constexpr short wC = -5;
			auto vectorC = PonyBase::Math::Vector4<short>(xC, yC, zC, wC);
			PonyBase::Math::Vector4<short>& vectorL = vectorC += vectorR;
		...
		TEST_METHOD(SumAssignmentFloatTest)
		{
			...
			constexpr auto vectorR = PonyBase::Math::Vector4<float>(xR, yR, zR, wR);
			constexpr float xC = 6;
			constexpr float yC = 4;
			constexpr float zC = -2;
			constexpr float wC = -5;
			auto vectorC = PonyBase::Math::Vector4<float>(xC, yC, zC, wC);
			PonyBase::Math::Vector4<float>& vectorL = vectorC += vectorR;
		...
		TEST_METHOD(MultiplyAssignmentShortTest)
		{
			...
			constexpr short wC = -5;
			auto vectorC = PonyBase::Math::Vector4<short>(xC, yC, zC, wC);
			PonyBase::Math::Vector4<short>& vectorL = vectorC *= multiplierI;
			...
			vectorC = PonyBase::Math::Vector4<short>(xC, yC, zC, wC);
			PonyBase::Math::Vector4<short>& vectorL1 = vectorC *= multiplierF;
		...
		TEST_METHOD(MultiplyAssignmentFloatTest)
		{
			...
			constexpr float wC = -5;
			auto vectorC = PonyBase::Math::Vector4<float>(xC, yC, zC, wC);
			PonyBase::Math::Vector4<float>& vectorL = vectorC *= multiplier;
		...
		TEST_METHOD(EqualityShortTest)
		{
			...
			constexpr short w = -5;
			constexpr auto vector = PonyBase::Math::Vector4<short>(x, y, z, w);
			PonyBase::Math::Vector4<short> otherVector = vector;

			Assert::IsTrue(vector == otherVector);
			Assert::IsFalse(vector != otherVector);

			for (std::size_t i = 0; i < PonyBase::Math::Vector4<short>::ComponentCount; ++i)
			{
		...
		TEST_METHOD(EqualityFloatTest)
		{
			...
			constexpr float w = -5;
			constexpr auto vector = PonyBase::Math::Vector4<float>(x, y, z, w);
			PonyBase::Math::Vector4<float> otherVector = vector;
		...
		{
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::One == PonyBase::Math::Vector4<float>(1, 1, 1, 1));
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::Zero == PonyBase::Math::Vector4<float>(0, 0, 0, 0));
			Assert::IsTrue(PonyBase::Math::Vector4<float>::Predefined::Negative == PonyBase::Math::Vector4<float>(-1, -1, -1, -1));

			Assert::IsTrue(PonyBase::Math::Vector4<short>::Predefined::One == PonyBase::Math::Vector4<short>(1, 1, 1, 1));
			Assert::IsTrue(PonyBase::Math::Vector4<short>::Predefined::Zero == PonyBase::Math::Vector4<short>(0, 0, 0, 0));
			Assert::IsTrue(PonyBase::Math::Vector4<short>::Predefined::Negative == PonyBase::Math::Vector4<short>(-1, -1, -1, -1));
		}
		...
		TEST_METHOD(DotShortTest)
		{
			...
			short zR = 5;
			short wR = -2;
			auto vectorR = PonyBase::Math::Vector4<short>(xR, yR, zR, wR);
			short xL = 6;
			short yL = 4;
			short zL = -3;
			short wL = -5;
			auto vectorL = PonyBase::Math::Vector4<short>(xL, yL, zL, wL);
			...
			zR = 5;
			wR = 2;
			vectorR = PonyBase::Math::Vector4<short>(xR, yR, zR, wR);
			xL = 6;
			yL = 4;
			zL = 3;
			wL = 5;
			vectorL = PonyBase::Math::Vector4<short>(xL, yL, zL, wL);
		...
		TEST_METHOD(DotFloatTest)
		{
			...
			float zR = 5;
			float wR = -2;
			auto vectorR = PonyBase::Math::Vector4<float>(xR, yR, zR, wR);
			float xL = 6;
			float yL = 4;
			float zL = -3;
			float wL = -5;
			auto vectorL = PonyBase::Math::Vector4<float>(xL, yL, zL, wL);
			...
			zR = 5;
			wR = 2;
			vectorR = PonyBase::Math::Vector4<float>(xR, yR, zR, wR);
			xL = 6;
			yL = 4;
			zL = 3;
			wL = 5;
			vectorL = PonyBase::Math::Vector4<float>(xL, yL, zL, wL);
			dot = PonyBase::Math::Dot(vectorL, vectorR);
		...
		TEST_METHOD(DistanceShortTest)
		{
			...
			constexpr auto vectorL = PonyBase::Math::Vector4<short>(xL, yL, zL, wL);
			Assert::AreEqual(11.747, static_cast<double>(PonyBase::Math::Distance(vectorL, vectorR)), 0.001);
			Assert::AreEqual(short{138}, PonyBase::Math::DistanceSquared(vectorR, vectorL));
		}
		...
		TEST_METHOD(DistanceFloatTest)
		{
			...
			constexpr auto vectorL = PonyBase::Math::Vector4<float>(xL, yL, zL, wL);
			Assert::AreEqual(11.747, static_cast<double>(PonyBase::Math::Distance(vectorL, vectorR)), 0.001);
			Assert::AreEqual(138.f, PonyBase::Math::DistanceSquared(vectorR, vectorL));
		}
		...
		TEST_METHOD(AngleTest)
		{
			...
			float zR = 5;
			float wR = -2;
			auto vectorR = PonyBase::Math::Vector4<float>(xR, yR, zR, wR).Normalized();
			float xL = 6;
			float yL = 4;
			float zL = -3;
			float wL = -5;
			auto vectorL = PonyBase::Math::Vector4<float>(xL, yL, zL, wL).Normalized();
			...
			zR = 5;
			wR = 2;
			vectorR = PonyBase::Math::Vector4<float>(xR, yR, zR, wR).Normalized();
			xL = 6;
			yL = 4;
			zL = 3;
			wL = 5;
			vectorL = PonyBase::Math::Vector4<float>(xL, yL, zL, wL).Normalized();
		...
		TEST_METHOD(ProjectTest)
		{
			...
			float wL = -5;
			auto vectorL = PonyBase::Math::Vector4<float>(xL, yL, zL, wL);
			PonyBase::Math::Vector4<float> projected = PonyBase::Math::Project(vectorL, vectorR);
			...
			projected = PonyBase::Math::Project(vectorL, vectorL.Normalized());
		...
		TEST_METHOD(ScaleShortTest)
		{
			...
			constexpr short wL = -5;
			constexpr auto vectorL = PonyBase::Math::Vector4<short>(xL, yL, zL, wL);
			const PonyBase::Math::Vector4<short> scaled = PonyBase::Math::Scale(vectorL, vectorR);
		...
		TEST_METHOD(ScaleFloatTest)
		{
			...
			constexpr float wL = -5;
			constexpr auto vectorL = PonyBase::Math::Vector4<float>(xL, yL, zL, wL);
			const PonyBase::Math::Vector4<float> scaled = PonyBase::Math::Scale(vectorL, vectorR);
		...
		TEST_METHOD(MinCombinedShortTest)
		{
			...
			constexpr auto vector1 = PonyBase::Math::Vector4<short>(x1, y1, z1, w1);
		...
		TEST_METHOD(MinCombinedFloatTest)
		{
			...
			constexpr auto vector1 = PonyBase::Math::Vector4<float>(x1, y1, z1, w1);
			auto min = PonyBase::Math::Min(vector, vector1);
			Assert::AreEqual(x, min.X());
			Assert::AreEqual(y1, min.Y());
			Assert::AreEqual(z, min.Z());
		...
		TEST_METHOD(ClampShortTest)
		{
			...
			constexpr auto vector2 = PonyBase::Math::Vector4<short>(x2, y2, z2, w2);
		...
		TEST_METHOD(ClampFloatTest)
		{
			...
			constexpr auto vector2 = PonyBase::Math::Vector4<float>(x2, y2, z2, w2);
		...
		TEST_METHOD(LerpShortTest)
		{
			...
			PonyBase::Math::Vector4<short> lerped = PonyBase::Math::Lerp(vectorL, vectorR, 0.f);
		...
		TEST_METHOD(LerpFloatTest)
		{
			...
			PonyBase::Math::Vector4<float> lerped = PonyBase::Math::Lerp(vectorL, vectorR, 0.f);
			Assert::AreEqual(xL, lerped.X());
			Assert::AreEqual(yL, lerped.Y());
			Assert::AreEqual(zL, lerped.Z());
			Assert::AreEqual(wL, lerped.W());
		...
		TEST_METHOD(AreAlmostEqualTest)
		{
			...
			constexpr float wR = -2;
			constexpr auto vectorR = PonyBase::Math::Vector4<float>(xR, yR, zR, wR);
			PonyBase::Math::Vector4<float> vectorL = vectorR;
		...
		TEST_METHOD(SumShortTest)
		{
			...
			const PonyBase::Math::Vector4<short> sum = vectorL + vectorR;
		...
		TEST_METHOD(SumFloatTest)
		{
			...
			const PonyBase::Math::Vector4<float> sum = vectorL + vectorR;
		...
		TEST_METHOD(NegateShortTest)
		{
			...
			const PonyBase::Math::Vector4<short> negated = -vectorR;
		...
		TEST_METHOD(NegateFloatTest)
		{
			...
			const PonyBase::Math::Vector4<float> negated = -vectorR;
		...
		TEST_METHOD(SubtractShortTest)
		{
			...
			const PonyBase::Math::Vector4<short> difference = vectorL - vectorR;
		...
		TEST_METHOD(SubtractFloatTest)
		{
			...
			const PonyBase::Math::Vector4<float> difference = vectorL - vectorR;
		...
		TEST_METHOD(MultiplyShortTest)
		{
			...
			PonyBase::Math::Vector4<short> product = vectorL * multiplierI;
		...
		TEST_METHOD(MultiplyFloatTest)
		{
			...
			const PonyBase::Math::Vector4<float> product = vectorL * multiplier;
		...
		TEST_METHOD(DivideShortTest)
		{
			...
			PonyBase::Math::Vector4<short> product = vectorL / divisorI;
		...
		TEST_METHOD(DivideFloatTest)
		{
			...
			const PonyBase::Math::Vector4<float> product = vectorL / divisor;
		...
		static constexpr PonyBase::Math::Vector4<float> VectorConstexpr()
		{
			[[maybe_unused]] auto vector = PonyBase::Math::Vector4<float>(4, 5, 1, 6);
			PonyBase::Math::Vector4<float> movedVector = std::move(vector);
			...
			[[maybe_unused]] constexpr auto constVector = PonyBase::Math::Vector4<float>(4, 5, 1, 6);
			...
			movedVector += PonyBase::Math::Vector4<float>(4, 5, 1, 6);
			movedVector -= PonyBase::Math::Vector4<float>(4, 5, 1, 6);
			movedVector *= 4.f;
			movedVector /= 4.f;
			movedVector *= 3;
			...
			[[maybe_unused]] auto movedVector1 = PonyBase::Math::Vector4<float>();
		...
		{
			[[maybe_unused]] constexpr auto one = PonyBase::Math::Vector4<float>::Predefined::One;
			[[maybe_unused]] constexpr auto zero = PonyBase::Math::Vector4<float>::Predefined::Zero;
			[[maybe_unused]] constexpr auto negative = PonyBase::Math::Vector4<float>::Predefined::Negative;

			[[maybe_unused]] constexpr auto defaultVector = PonyBase::Math::Vector4<float>();
			[[maybe_unused]] constexpr auto vector = PonyBase::Math::Vector4<float>(4, 5, 1, 6);
			[[maybe_unused]] constexpr auto arrayVector = PonyBase::Math::Vector4<float>(std::array<float, 4>{4, 5, 1, 6});
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> copiedVector = vector;
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> movedVector = VectorConstexpr();
			...
			[[maybe_unused]] constexpr auto intVector = static_cast<PonyBase::Math::Vector4<int>>(vector);
			...
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> project = PonyBase::Math::Project(vector, PonyBase::Math::Vector4<float>(1, 0, 0, 0));

			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> scale = PonyBase::Math::Scale(vector, arrayVector);

			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> minCombined = PonyBase::Math::Min(defaultVector, arrayVector);
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> maxCombined = PonyBase::Math::Max(defaultVector, arrayVector);
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> clamped = PonyBase::Math::Clamp(vector, defaultVector, arrayVector);
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> lerp = PonyBase::Math::Lerp(vector, arrayVector, 0.5f);

			[[maybe_unused]] constexpr bool areAlmostEqual = PonyBase::Math::AreAlmostEqual(vector, arrayVector);

			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> sum = vector + arrayVector;
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> difference = vector - arrayVector;
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> product = vector * 3.f;
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> productL = 3.f * vector;
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<float> quotient = vector / 2.f;
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<int> productI = PonyBase::Math::Vector4<int>(4, 5, 1, 6) * 3;
			[[maybe_unused]] constexpr PonyBase::Math::Vector4<int> productIL = 3 * PonyBase::Math::Vector4<int>(4, 5, 1, 6);
		}
	};
}
