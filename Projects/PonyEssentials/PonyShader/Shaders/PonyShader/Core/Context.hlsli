...
struct Pony_Context
{
	...
	Pony_ThreadGroupCounts pipelineStateThreadGroupCounts; ///< How many thread groups are required by a pipeline state. It takes just the number without considering a mode declared in the pipeline state.
