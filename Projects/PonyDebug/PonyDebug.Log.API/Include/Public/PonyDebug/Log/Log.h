...
#define PONY_LOG_VERBOSE_MASK (1u << static_cast<unsigned int>(PonyDebug::Log::LogType::Verbose))
#else
/// @brief Verbose log mask.
#define PONY_LOG_VERBOSE_MASK 0u
#endif

#ifdef PONY_LOG_DEBUG
/// @brief Debug log mask.
#define PONY_LOG_DEBUG_MASK (1u << static_cast<unsigned int>(PonyDebug::Log::LogType::Debug))
#else
/// @brief Debug log mask.
#define PONY_LOG_DEBUG_MASK 0u
#endif

#ifdef PONY_LOG_INFO
/// @brief Info log mask.
#define PONY_LOG_INFO_MASK (1u << static_cast<unsigned int>(PonyDebug::Log::LogType::Info))
#else
/// @brief Info log mask.
#define PONY_LOG_INFO_MASK 0u
#endif

#ifdef PONY_LOG_WARNING
/// @brief Warning log mask.
#define PONY_LOG_WARNING_MASK (1u << static_cast<unsigned int>(PonyDebug::Log::LogType::Warning))
#else
/// @brief Warning log mask.
#define PONY_LOG_WARNING_MASK 0u
#endif

#ifdef PONY_LOG_ERROR
/// @brief Error log mask.
#define PONY_LOG_ERROR_MASK (1u << static_cast<unsigned int>(PonyDebug::Log::LogType::Error))
#else
/// @brief Error log mask.
#define PONY_LOG_ERROR_MASK 0u
#endif

#ifdef PONY_LOG_EXCEPTION
/// @brief Exception log mask.
#define PONY_LOG_EXCEPTION_MASK (1u << static_cast<unsigned int>(PonyDebug::Log::LogType::Exception))
#else
/// @brief Exception log mask.
#define PONY_LOG_EXCEPTION_MASK 0u
#endif
...
#else
/// @brief Console log mask.
#define PONY_CONSOLE_LOG_MASK 0u
#endif
...
#define PONY_LOG(logger, logType, logMessage, ...) \
	if constexpr (1u << (logType) & PONY_LOG_MASK) \
	{ \
...
#define PONY_LOG_E_S(logger, exception) \
	if constexpr (PONY_LOG_EXCEPTION_MASK) \
	{ \
...
#define PONY_CONSOLE(logType, logMessage, ...) \
	if constexpr (1u << (logType) & PONY_CONSOLE_LOG_MASK) \
	{ \
...
#define PONY_CONSOLE_E_S(exception) \
	if constexpr (PONY_LOG_EXCEPTION_MASK & PONY_CONSOLE_LOG_MASK) \
	{ \
