...
export namespace PonyEngine::Window
{
	...
	struct WindowRect final
	{
		...
		PonyMath::Core::Vector2<std::int32_t> position = PonyMath::Core::Vector2<std::int32_t>(10, 10); ///< Window client area position. Left-upper corner. It's used only if @p fullscreen is @a false.
