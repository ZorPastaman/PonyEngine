...
export module PonyEngine.Input.Windows.Detail:KeyboardDevice;
...
{ 
	...
	{
	public:
		/// @brief Creates a @p KeyboardDevice.
		...
		KeyboardDevice(IInputSystemContext& inputSystem, const DeviceParams& deviceParams, const KeyboardDeviceParams& keyboardParams);
		KeyboardDevice(const KeyboardDevice&) = delete;
		KeyboardDevice(KeyboardDevice&&) = delete;

		virtual ~KeyboardDevice() noexcept override = default;
...
namespace PonyEngine::Input::Windows
{
	...
	KeyboardDevice::KeyboardDevice(IInputSystemContext& inputSystem, const DeviceParams& deviceParams, const KeyboardDeviceParams&) :
		Device(inputSystem, deviceParams)
	{
	}

	void KeyboardDevice::Begin()
	{
	...
	void KeyboardDevice::Tick() noexcept
	{
	}

	void KeyboardDevice::Observe(const UINT uMsg, const WPARAM, const LPARAM lParam)
	{
