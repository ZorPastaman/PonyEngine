...
export namespace PonyEngine::Window
{
	...
	PONY_DLL_EXPORT IWindowsWindowFactory* CreateWindowsWindowFactory(Log::ILogger& logger, const WindowsClassParams& classParams);
...
{
	IWindowsWindowFactory* CreateWindowsWindowFactory(Log::ILogger& logger, const WindowsClassParams& classParams)
	{
