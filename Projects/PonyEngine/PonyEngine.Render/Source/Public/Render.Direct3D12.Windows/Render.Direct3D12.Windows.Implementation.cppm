...
export namespace PonyEngine::Render
{
	...
	PONY_DLL_EXPORT WindowsDirect3D12RenderSystemFactoryData CreateWindowsDirect3D12RenderSystemFactory(Core::IApplicationContext& application, const WindowsDirect3D12RenderSystemFactoryParams& params);
}

namespace PonyEngine::Render
{
	WindowsDirect3D12RenderSystemFactoryData CreateWindowsDirect3D12RenderSystemFactory(Core::IApplicationContext&, const WindowsDirect3D12RenderSystemFactoryParams&)
	{
		auto factory = PonyBase::Memory::UniquePointer<WindowsDirect3D12RenderSystemFactory>::Create();
