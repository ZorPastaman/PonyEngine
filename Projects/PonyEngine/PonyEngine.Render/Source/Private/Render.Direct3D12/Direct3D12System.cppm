...
export namespace PonyEngine::Render
{
	...
	public:
		...
		void CreateRenderSystem(const Direct3D12BackParams& backParams, const Direct3D12RenderTargetParams& renderTargetParams, const Direct3D12RenderViewParams& renderViewParams);
	...
	private:
		...
		[[nodiscard("Pure function")]]
		virtual IDirect3D12BackPrivate& BackPrivate() noexcept override;
		[[nodiscard("Pure function")]]
		virtual const IDirect3D12BackPrivate& BackPrivate() const noexcept override;
		...
		std::unique_ptr<Direct3D12Back> back; ///< Back.
...
namespace PonyEngine::Render
{
	...
	void Direct3D12System::CreateRenderSystem(const Direct3D12BackParams& backParams, const Direct3D12RenderTargetParams& renderTargetParams, const Direct3D12RenderViewParams& renderViewParams)
	{
		PONY_LOG(renderSystem->Logger(), PonyDebug::Log::LogType::Info, "Create back.");
		back = std::make_unique<Direct3D12Back>(*static_cast<IDirect3D12SystemContext*>(this), backParams);
		back->Name("Back");
	...
	IDirect3D12BackPrivate& Direct3D12System::BackPrivate() noexcept
	{
		return *back;
	}

	const IDirect3D12BackPrivate& Direct3D12System::BackPrivate() const noexcept
	{
		return *back;
	}
