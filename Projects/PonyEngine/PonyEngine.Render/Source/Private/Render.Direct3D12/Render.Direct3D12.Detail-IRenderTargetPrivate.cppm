...
export module PonyEngine.Render.Direct3D12.Detail:IRenderTargetPrivate;
...
export namespace PonyEngine::Render::Direct3D12
{
	...
	class IRenderTargetPrivate : public IRenderTarget
	{
		INTERFACE_BODY(IRenderTargetPrivate)
