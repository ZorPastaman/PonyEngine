...
export namespace PonyEngine::Render
{
	...
	public:
		...
		virtual std::shared_ptr<Direct3D12Material> CreateMaterial(const std::shared_ptr<Direct3D12RootSignature>& rootSignature, const Direct3D12Shader& meshShader, const Direct3D12Shader& pixelShader) override;
...
namespace PonyEngine::Render
{
	...
	std::shared_ptr<Direct3D12Material> Direct3D12MaterialManager::CreateMaterial(const std::shared_ptr<Direct3D12RootSignature>& rootSignature, const Direct3D12Shader& meshShader, const Direct3D12Shader& pixelShader)
	{
		...
		const auto material = std::make_shared<Direct3D12Material>(rootSignature, *pipelineState.Get());
