...
namespace Game
{
	GameSystemFactory::GameSystemFactory(PonyEngine::Core::IApplicationContext& application, const GameSystemFactoryParams&, const GameSystemParams& systemParams) noexcept :
