...
namespace Game
{
	...
	void Game::Begin()
	{
		...
		{
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Register up input.");
			...
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Up input registered.");

			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Register down input.");
			...
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Down input registered.");

			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Register right input.");
			...
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Right input registered.");

			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Register left input.");
			...
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Left input registered.");
		}
		else
		{
	...
	void Game::End()
	{
		...
		if (auto const inputSystem = m_engine.FindSystem<PonyEngine::Input::IInputSystem>())
		{
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Unregister up input.");
			inputSystem->UnregisterAction(m_upHandle);
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Up input unregistered.");
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Unregister down input.");
			inputSystem->UnregisterAction(m_downHandle);
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Down input unregistered.");
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Unregister right input.");
			inputSystem->UnregisterAction(m_rightHandle);
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Right input unregistered.");
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Unregister left input.");
			inputSystem->UnregisterAction(m_leftHandle);
			PONY_LOG(m_engine.GetLogger(), LogType::Debug, "Left input unregistered.");
		}
