...
### [Object shader](GameSample/Assets/Shaders/Mesh/Object.hlsl)

Simple mesh shader to draw an object.

### [Fullscreen quad shader](GameSample/Assets/Shaders/Mesh/FullscreenQuad.hlsl)

Mesh shader that draw a fullscreen quad. It's used for the final SRGB output.

### [Pixel shader](GameSample/Assets/Shaders/Pixel/Pixel.hlsl)

Simple pixel shader that paints the whole object with a given color.

### [Texture.hlsl](GameSample/Assets/Shaders/Pixel/Texture.hlsl)

Simple pixel shader that paints the whole object with a given texture.
...
| Space     | Move up.               |
| Left Ctrl | Move down.             |
| Mouse X   | Rotate around local Y. |
| Mouse Y   | Rotate around local X. |
| Q/E       | Rotate around local Z. |
| Enter     | Reset scene.           |
| Escape    | Quit.                  |
