...
function(pony_set_build_options target_name is_engine_target)
	function(set_build_options target_name optimization)
	...
	if(is_engine_target)
		set_build_options(${target_name} ${PONY_ENGINE_OPTIMIZATION})
	else()
		set_build_options(${target_name} ${PONY_GAME_OPTIMIZATION})
	endif()
endfunction()
