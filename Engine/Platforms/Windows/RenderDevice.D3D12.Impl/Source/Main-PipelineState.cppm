...
export module PonyEngine.RenderDevice.D3D12.Impl.Windows:PipelineState;
...
export namespace PonyEngine::RenderDevice::D3D12
{
	...
	public:
		...
		/// @param pipelineState Pipeline state.
		[[nodiscard("Pure constructor")]]
		explicit PipelineState(Platform::ComPtr<ID3D12PipelineState>&& pipelineState) noexcept;
	...
	private:
		Platform::ComPtr<ID3D12PipelineState> pipelineState; ///< Pipeline state.
...
namespace PonyEngine::RenderDevice::D3D12
{
	...
	PipelineState::PipelineState(Platform::ComPtr<ID3D12PipelineState>&& pipelineState) noexcept :
