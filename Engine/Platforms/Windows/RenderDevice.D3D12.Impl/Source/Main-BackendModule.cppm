...
export module PonyEngine.RenderDevice.D3D12.Impl.Windows:BackendModule;
...
namespace PonyEngine::RenderDevice::D3D12::Windows
{
	...
	{
		IRenderDeviceModuleContext* const renderDeviceModuleContext = context.GetData<IRenderDeviceModuleContext>();
#ifndef NDEBUG
