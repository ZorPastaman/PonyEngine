...
export namespace PonyEngine::RawInput
{
	...
	class IRawInputService
	{
		...
		/// @note Don't call it during the raw input service tick.
		/// @note This function mustn't be called on different threads at the same time.
		/// @note This function mustn't be called while @p RemoveObserver(IDeviceObserver&) is executing.
		virtual void AddObserver(IDeviceObserver& observer) = 0;
		/// @brief Removes the global device observer.
		/// @param observer Device observer.
		/// @note Don't call it during the raw input service tick.
		/// @note This function mustn't be called on different threads at the same time.
		/// @note This function mustn't be called while @p AddObserver(IDeviceObserver&) is executing.
		...
		/// @note Don't call it during the raw input service tick.
		/// @note This function mustn't be called on different threads at the same time.
		/// @note This function mustn't be called while @p RemoveObserver(IRawInputObserver&) is executing.
		virtual void AddObserver(IRawInputObserver& observer) = 0;
		/// @brief Removes the global raw input observer.
		/// @param observer Raw input observer.
		/// @note Don't call it during the raw input service tick.
		/// @note This function mustn't be called on different threads at the same time.
		/// @note This function mustn't be called while @p AddObserver(IRawInputObserver&) is executing.
