...
| `PONY_LOG_FATAL`                | If defined, fatal logs are compiled.            |
...
| `PONY_LOG_STACKTRACE_FATAL`     | If defined, fatal logs include stacktraces.     |
...
PONY_LOG(application->Logger(), PonyEngine::Log::LogType::Error, std::current_exception());
PONY_LOG(application->Logger(), PonyEngine::Log::LogType::Error, std::current_exception(), "On validating.");
PONY_LOG(application->Logger(), PonyEngine::Log::LogType::Error, std::current_exception(), "On validating value: {}.", value);
PONY_LOG(condition, application->Logger(), PonyEngine::Log::LogType::Error, std::current_exception(), "On validating value: {}.", value);
```
