...
#ifdef PONY_LOG_FATAL
/// @brief Fatal log mask.
#define PONY_LOG_FATAL_MASK PonyEngine::Log::LogTypeMask::Fatal
#else
/// @brief Fatal log mask.
#define PONY_LOG_FATAL_MASK PonyEngine::Log::LogTypeMask::None
#endif
...
#ifdef PONY_LOG_STACKTRACE_FATAL
/// @brief Fatal log stacktrace mask.
#define PONY_LOG_STACKTRACE_FATAL_MASK PonyEngine::Log::LogTypeMask::Fatal
#else
/// @brief Fatal log stacktrace mask.
#define PONY_LOG_STACKTRACE_FATAL_MASK PonyEngine::Log::LogTypeMask::None
#endif

/// @brief Log mask. It contains a mask of all possible log types.
#define PONY_LOG_MASK (PONY_LOG_VERBOSE_MASK | PONY_LOG_DEBUG_MASK | PONY_LOG_INFO_MASK | PONY_LOG_WARNING_MASK | PONY_LOG_ERROR_MASK | PONY_LOG_FATAL_MASK)
