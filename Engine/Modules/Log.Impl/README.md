...
- [Logger](Source/Log-Logger.cppm) - logger;
- [LoggerModule](Source/Log-LoggerModule.cppm) - logger module;
- [LogFiller](Source/Log-LogFiller.cppm) - utility functions to make a formatted string.

The [Logger](Source/Log-Logger.cppm) uses `thread_local` strings as formatted string cache to minimize allocations and make logging multithreading-friendly.
